 ...
 *
 * Traços de item da armadura do Avaritia:
 *  - Indestrutível (sem durabilidade → nunca quebra, sem barra de dano)
...
public class SansArmorItem extends ArmorItem {
    ...
    public SansArmorItem(ArmorItem.Type type) {
        // Sem .durability(...) → indestrutível. O material SANS dá as texturas no corpo
