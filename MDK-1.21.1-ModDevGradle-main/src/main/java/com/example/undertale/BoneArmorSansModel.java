...
public class BoneArmorSansModel extends GeoModel<BoneArmorSansEntity> {
    ...
    public static final ResourceLocation TEX_FLYING =
            ResourceLocation.fromNamespaceAndPath(UndertaleMod.MOD_ID, "textures/entity/bone_armor_sans_flying.png");
    public static final ResourceLocation TEX_ATTACKING =
            ResourceLocation.fromNamespaceAndPath(UndertaleMod.MOD_ID, "textures/entity/bone_armor_sans_attacking.png");

    @Override
    public ResourceLocation getModelResource(BoneArmorSansEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(UndertaleMod.MOD_ID, "geo/bone_armor_sans.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(BoneArmorSansEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(UndertaleMod.MOD_ID, "animations/bone_armor_sans.animation.json");
    }
}
